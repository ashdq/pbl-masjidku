    ...
    >
      <div className="max-w-md mx-auto">
        ...
        >
          ...
          >
            <FiArrowLeft className="mr-2" /> Kembali ke Daftar Pengeluaran
          </button>
        </motion.div>
        ...
        >
          ...
          <form onSubmit={handleSubmit}>
            ...
            <motion.button
              ...
              type="submit"
              disabled={loading}
              className={`w-full py-3 px-4 bg-gradient-to-r from-blue-600 to-green-600 hover:from-blue-700 hover:to-green-700 text-white font-medium rounded-lg shadow-md transition ${loading ? 'opacity-70 cursor-not-allowed' : ''}`}
            >
              {loading ? (
