...
export default function LoginPage() {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-cover bg-center bg-no-repeat" style={{ backgroundImage: "url('/images/masjid-login.jpg')" }}>
      <div className="bg-white/70 backdrop-blur-lg rounded-xl shadow-2xl md:flex md:max-w-2xl lg:max-w-3xl overflow-hidden w-full animate__animated animate__fadeInDown">
        {/* Left Form Side */}
        <div className="p-8 md:p-12 lg:p-16 md:w-1/2 space-y-5 animate__animated animate__fadeInLeft">
          ...
          {/* <div className="mt-6 flex items-center gap-3">
            <button className="flex-1 flex items-center justify-center gap-2 py-2 px-4 border border-gray-300 rounded-md bg-white hover:bg-gray-100 transition">
              <FcGoogle /> Google
            </button>
            <button className="flex-1 flex items-center justify-center gap-2 py-2 px-4 border border-blue-600 rounded-md bg-blue-500 text-white hover:bg-blue-600 transition">
              <FaFacebook /> Facebook
            </button>
          </div> */}
        ...
        {/* Right Side */}
        <div className="md:w-1/2 bg-gradient-to-br from-green-600 to-green-400 text-white relative hidden md:flex flex-col justify-center items-center overflow-hidden animate__animated animate__fadeInRight">
          <img
            src="/aa.png"
            alt="Masjid"
