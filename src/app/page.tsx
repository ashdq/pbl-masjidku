...
function NavItem({ label }: { label: string }) {
  return (
    <li>
      <a
        href="#"
        className="p-3 text-gray-800 hover:text-green-600 font-medium transition duration-200 ease-in-out"
      >
        {label}
      </a>
    </li>
...
function NavbarWithSimpleLinks() {
  ...
  const navbarClassName = `fixed top-0 left-0 right-0 z-10 transition duration-300 ease-in-out ${
  ...
  return (
    <nav className={navbarClassName}>
      <div className="container max-w-7xl mx-auto flex items-center justify-between px-4 sm:px-6 lg:px-8 py-3">
        <div className="text-xl font-extrabold text-green-600">Masjidku</div>
        ...
        <ul className="hidden lg:flex gap-8 items-center">
          ...
          <li>
            <Link href="/login">
              <span className="px-5 py-2 bg-green-600 text-white rounded-md hover:bg-green-700 transition duration-200 ease-in-out cursor-pointer">
                Sign In
              </span>
            </Link>
          </li>
      ...
      {open && (
        <div className="lg:hidden bg-white shadow-md px-4 py-4">
          <ul className="flex flex-col gap-4">
            ...
            <NavItem label="Contact Us" />
            <Link href="/login">
              <span className="block px-5 py-2 bg-green-600 text-white text-center rounded-md hover:bg-green-700 transition duration-200 ease-in-out cursor-pointer">
                Sign In
              </span>
            </Link>
          </ul>
    ...
    <div className="font-sans antialiased">
      ...
      >
        <div className="container max-w-3xl mx-auto">
          ...
          <button className="bg-white text-green-600 font-semibold px-8 py-3 rounded-full hover:bg-gray-100 transition ease-in-out duration-300 text-lg">
            Mulai Sekarang
          </button>
        </div>
      </section>
